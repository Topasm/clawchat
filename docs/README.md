...
| [Roadmap](./roadmap.md) | Development progress and upcoming work |
...
- **Kanban Task Board** — Drag-and-drop kanban board (Todo / In Progress / Done) with HTML5 Drag and Drop API, visual column highlights, and responsive layout
