...
- **Inbox Triage Canvas** — Place the same captured Task into a Project hierarchy, reorder siblings, preview dependency impact, and safely apply validated connections
