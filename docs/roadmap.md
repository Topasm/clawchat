...
- [x] HTML5 drag-and-drop between kanban columns (no external deps)
- [x] Visual feedback: drag-over column highlights (blue/yellow/green), card opacity
...
### Shared Components
- [x] TaskCard, Badge (priority/due/tag/status/count variants)
