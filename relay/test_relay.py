...
def test_relay_forwards_opaque_frames_both_directions():
    ...
    with TestClient(app) as client:
        with client.websocket_connect("/v1/relay/host/claw_test") as host:
            with client.websocket_connect("/v1/relay/client/claw_test") as mobile:
...
def test_client_gets_explicit_offline_signal():
    broker.hosts.clear()
    with TestClient(app) as client:
        with client.websocket_connect("/v1/relay/client/missing") as mobile:
